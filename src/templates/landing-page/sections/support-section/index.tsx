...
export function SupportSection() {
  return (
    <section className="relative pb-8 md:py-10 bg-linear-to-r from-gray-500 to-gray-700">
      <div className="absolute inset-0 hidden md:block bg-[url('/background-features.svg')] bg-cover bg-center bg-no-repeat" />
      <div className="container flex flex-col items-center gap-12 relative">
        <h2 className={"font-sans text-balance text-center text-heading-xl"}>
