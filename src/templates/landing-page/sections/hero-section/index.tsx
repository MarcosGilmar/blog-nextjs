  ...
  return (
    <section className="container relative flex items-center justify-center mt-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-80 md:h-144 items-center">
        <div className="flex flex-col items-center justify-center gap-4 sm:items-start lg:items-start">
          <h1 className="text-gray-100 text-heading-hg font-sans text-center sm:text-left">
        ...
        <div className="relative h-80 hidden md:h-full order-first items-center justify-center md:order-last  md:flex lg:flex">
          <Image
            src="/background.svg"
